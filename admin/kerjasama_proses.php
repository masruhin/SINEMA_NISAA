...
if (isset($_POST['upload'])) {
  ...
  if ($nama2 == '') {
    $insert    = mysqli_query($kon, "INSERT INTO kerjasama (status_kerjasama,tanggal_awal,tanggal_akhir,id_jenis_dok,id_fak,id_unit,judul_kerjasama,deskripsi_kerjasama,no_ref_kerjasama) 
    VALUES('$status_kerjasama','$tanggal_awal','$tanggal_akhir','$id_jenis_dok','$id_fak','$id_unit','$judul_kerjasama','$deskripsi_kerjasama','$no_ref_kerjasama')");
    // var_dump($insert);
    // die();
